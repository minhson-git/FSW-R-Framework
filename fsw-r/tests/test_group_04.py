...
from fsw_r.groups.group_04_four_fingers import (
    BaseSymbol01_04_001_FourFingers,
    BaseSymbol01_04_002_FourFingersBent,
    BaseSymbol01_04_003_FourFingersHinge,
    BaseSymbol01_04_004_FourFingersUnit,
    BaseSymbol01_04_005_FourFingersUnitSplit,
    BaseSymbol01_04_006_FourFingersUnitClaw,
    BaseSymbol01_04_007_FourFingersUnitBent,
    BaseSymbol01_04_008_FourFingersUnitHinge,
)

# (base_symbol_number, class, base hex nibble for the FSW key)
GROUP_4_SYMBOLS = [
    (1, BaseSymbol01_04_001_FourFingers),
    (2, BaseSymbol01_04_002_FourFingersBent),
    (3, BaseSymbol01_04_003_FourFingersHinge),
    (4, BaseSymbol01_04_004_FourFingersUnit),
    (5, BaseSymbol01_04_005_FourFingersUnitSplit),
    (6, BaseSymbol01_04_006_FourFingersUnitClaw),
    (7, BaseSymbol01_04_007_FourFingersUnitBent),
    (8, BaseSymbol01_04_008_FourFingersUnitHinge),
]
GROUP_4_BASE_HEX = 0x144  # group 4 starts here, see core/fsw_symbol_key.py


@pytest.mark.parametrize("base_symbol_number,cls", GROUP_4_SYMBOLS)
def test_symbol_id_and_hand_side(base_symbol_number: int, cls: type) -> None:
    ...
    assert right.symbol_id == f"01-04-{base_symbol_number:03d}"
